...
class DryingListAdapter (private val dryinglist:MutableList<DryingModel>,private val onClickDelete:(String)->Unit,private val onClickInfo:(String)->Unit,private val onClickEdit:(String)->Unit): RecyclerView.Adapter<DryingListViewHolder>() {
