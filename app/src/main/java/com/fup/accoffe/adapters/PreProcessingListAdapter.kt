...
class PreProcessingListAdapter (private val preprocessinglist:MutableList<PreProcessingModel>,private val onClickEdit:(String)->Unit,private val onClickInfo:(String)->Unit,private val onClickDelete:(String)->Unit): RecyclerView.Adapter<PreProcessingListViewHolder>() {
