        ...
        if (PlantationId != null) {
            ...
            binding.botonSave.setOnClickListener {
                ...
                val datosActualizados = hashMapOf(
                    "p_year" to p_year,
                    "p_vel_viento" to p_vel_viento.toDouble(),
                    "p_aspec_hidrico" to p_aspec_hidrico.toDouble(),
                    "p_perdida_suelo" to p_perdida_suelo.toDouble(),
                    "p_urea" to p_urea.toDouble(),
                    "p_albedo" to p_albedo.toDouble(),
                    "p_duracion_cult" to p_duracion_cult.toDouble(),
                    "p_agua" to p_agua.toDouble(),
                    "p_cont_materia_orga" to p_cont_materia_orga.toDouble(),
                    "p_cal" to p_cal.toDouble(),
                    "p_pest_fung" to p_pest_fung.toDouble(),
                    "p_promedio_inso" to p_promedio_inso.toDouble(),
                    "p_evaporacion_poten" to p_evaporacion_poten.toDouble(),
                    "p_promedio_altura" to p_promedio_altura.toDouble(),
                    "p_ferti_nitro" to p_ferti_nitro.toDouble(),
                    "p_materia_orga" to p_materia_orga.toDouble(),
                    "l_siembra_mante" to l_siembra_mante.toDouble(),
                    "p_capa_admos" to p_capa_admos.toDouble(),
                    "p_coefi_cult" to p_coefi_cult.toDouble(),
                    "p_densidad" to p_densidad.toDouble(),
                    "p_ferti_fosfato" to p_ferti_fosfato.toDouble(),
                    "p_semillas" to p_semillas.toDouble(),
                    "area_finca" to area_finca.toDouble(),
                    "p_densidad_aire" to p_densidad_aire.toDouble(),
                    "l_p_energia_libre_gibbs" to p_energia_libre_gibbs.toDouble(),
                    "p_transpiracion" to p_transpiracion.toDouble(),
                    "p_ferti_potacio" to p_ferti_potacio.toDouble(),
                    "p_maq_man" to p_maq_man.toDouble()
